...
<html lang="es">
    ...
    <body>
            ...
            <div class="container-fluid d-flex justify-content-between align-items-center">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                    <ul class="navbar-nav fs-5 align-items-md-center gap-md-3">
                        ...
                        <li class="nav-item"><a class="nav-link text-white fw-bold" href="carta.php">CARTA</a></li>
        ...
        <!-- CARTA CON SLIDER DE PROMOCIONES -->
        <div class="container my-5">
            ...
            <!-- CABECERA CARTA -->
            <div class="d-flex justify-content-between align-items-center mb-4 pb-2 border-bottom border-secondary flex-wrap gap-3">
            ...
            <div class="row g-3 mb-4">
                <div class="col-12 col-md-6">
                    <div class="card bg-dark text-white border-secondary p-3 h-100">
                        <div class="row g-0 align-items-center">
                            <div class="col-4">
                                <img src="img/bebestible.jpg" alt="Limonada" class="img-fluid rounded w-100" style="height: 100px; object-fit: cover;">
                            </div>
                            <div class="col-8 ps-3">
        ...
        <div class="modal fade" id="modalPersonalizar" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content bg-dark text-white border-secondary">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-12 col-md-5 text-center mb-3">
                                <img id="modal-img" src="" alt="Plato" class="rounded img-fluid mb-2 w-100" style="height: 160px; object-fit: cover;">
                        ...
                        <div class="border-top border-secondary pt-3 mt-2">
                            ...
                            <div class="d-flex justify-content-between align-items-center bg-black bg-opacity-25 p-2 rounded mb-2 border border-secondary flex-wrap gap-2">
                                <div>
                    ...
                    <div class="modal-footer border-secondary justify-content-between align-items-center flex-wrap gap-2">
